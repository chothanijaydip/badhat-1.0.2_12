...
import 'package:badhat_b2b/ui/dashboard/home/category_products.dart';
...
BehaviorSubject<int> notificationCountController = BehaviorSubject();
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "category_products": (context) => CategoryProductsSreen(),
      },
    );
  }
}
...
// API for like button
// different field & values for some APIs in "profile_page" like state, wholeseller one
