  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {
      ...
      case SubcategoryEntity:
        return subcategoryEntityFromJson(data as SubcategoryEntity, json) as T;
      case SubcategoryData:
        return subcategoryDataFromJson(data as SubcategoryData, json) as T;
      case VerticalEntity:
        return verticalEntityFromJson(data as VerticalEntity, json) as T;
      case VerticalData:
        return verticalDataFromJson(data as VerticalData, json) as T;
