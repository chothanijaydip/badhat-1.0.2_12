...
productDetailEntityFromJson(
    ProductDetailEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
...
productDetailDataFromJson(ProductDetailData data, Map<String, dynamic> json) {
  ...
  if (json['subcategory'] != null) {
    data.subcategory =
        new ProductDetailDataSubcategory().fromJson(json['subcategory']);
  }
...
productDetailDataSubcategoryFromJson(
    ProductDetailDataSubcategory data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id']?.toInt();
  }
  if (json['name'] != null) {
...
Map<String, dynamic> productDetailDataSubcategoryToJson(
    ProductDetailDataSubcategory entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
  data['name'] = entity.name;
  data['category_id'] = entity.categoryId;
...
productDetailDataVerticalFromJson(
    ProductDetailDataVertical data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id']?.toInt();
  }
  if (json['name'] != null) {
...
Map<String, dynamic> productDetailDataVerticalToJson(
    ProductDetailDataVertical entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
  data['name'] = entity.name;
