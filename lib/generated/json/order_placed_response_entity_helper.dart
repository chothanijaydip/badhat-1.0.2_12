...
orderPlacedResponseEntityFromJson(
    OrderPlacedResponseEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
...
Map<String, dynamic> orderPlacedResponseEntityToJson(
    OrderPlacedResponseEntity entity) {
...
orderPlacedResponseDataFromJson(
    OrderPlacedResponseData data, Map<String, dynamic> json) {
  if (json['id'] != null) {
...
Map<String, dynamic> orderPlacedResponseDataToJson(
    OrderPlacedResponseData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
...
orderPlacedResponseDataItemFromJson(
    OrderPlacedResponseDataItem data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id']?.toInt();
  }
...
Map<String, dynamic> orderPlacedResponseDataItemToJson(
    OrderPlacedResponseDataItem entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
