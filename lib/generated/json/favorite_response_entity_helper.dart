...
favoriteResponseEntityFromJson(
    FavoriteResponseEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
    data.data = <FavoriteResponseData>[];
...
recommendedResponseEntityFromJson(
    RecommendedResponseEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
    data.data = <FavoriteResponseDataVendor>[];
    (json['data'] as List).forEach((v) {
      data.data.add(FavoriteResponseDataVendor().fromJson(v));
    });
  }
}

Map<String, dynamic> favoriteResponseEntityToJson(
    FavoriteResponseEntity entity) {
...
favoriteResponseDataFromJson(
    FavoriteResponseData data, Map<String, dynamic> json) {
  if (json['id'] != null) {
  ...
  if (json['vendor_retailer'] != null) {
    data.vendorRetailer = json['vendor_retailer'];
  }
  return data;
}
...
favoriteResponseDataVendorFromJson(
    FavoriteResponseDataVendor data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id']?.toInt();
  }
  if (json['name'] != null) {
...
Map<String, dynamic> favoriteResponseDataVendorToJson(
    FavoriteResponseDataVendor entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
