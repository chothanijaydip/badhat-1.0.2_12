...
subcategoryResponseEntityFromJson(
    SubcategoryResponseEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
...
Map<String, dynamic> subcategoryResponseEntityToJson(
    SubcategoryResponseEntity entity) {
...
subcategoryResponseDataFromJson(
    SubcategoryResponseData data, Map<String, dynamic> json) {
  if (json['id'] != null) {
...
Map<String, dynamic> subcategoryResponseDataToJson(
    SubcategoryResponseData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
...
subcategoryVerticalFromJson(
    SubcategoryVertical data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id']?.toInt();
  }
  if (json['name'] != null) {
