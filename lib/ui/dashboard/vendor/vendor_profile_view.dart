              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                                ...
                                Visibility(
                                    ...
                                    child:
                                        Text("Owner Name:  ${state.data.name}")
                                            .paddingTop(2)),
                                Text("${state.data.district}").paddingTop(2),
                      ...
                      (state.data.id >= 1000000001)
                          ? Visibility(
                              visible: (state.data.id >= 1000000000) &&
                                  (state.data.subCategory.isNotEmpty ||
                                      state.data.verticals.isNotEmpty),
