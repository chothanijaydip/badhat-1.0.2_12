                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                      "${state.data.data.user == null ? "" : state.data.data.user.name + " | "}${state.data.data.user == null ? "" : state.data.data.user.businessName}"),
                                ],
                              ).paddingAll(8),
                              Row(
                                mainAxisAlignment:
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    "${state.data.data.user.address}\n${state.data.data.user.district} - ${state.data.data.user.pincode}\n${state.data.data.user.state}",
                                  ),
                                ],
                              ).paddingAll(8),
                              Divider(
                          ...
                          Text("Note:")
                              ...
                              .fontSize(16)
                              .fontWeight(FontWeight.bold)
                              .paddingFromLTRB(16, 10, 0, 0),
                          Text("1. All payment & Delivery terms will be discussed between buyers and sellers")
                              .paddingFromLTRB(10, 10, 0, 0),
                          Text("2. Badhat helps in connecting & booking orders only")
                              .paddingFromLTRB(10, 10, 0, 0),
                          Text("3. Badhat does not offer any kind of assurance on products")
                              .paddingFromLTRB(10, 10, 0, 0),
                          SizedBox(
                            height: 50,
                          )
