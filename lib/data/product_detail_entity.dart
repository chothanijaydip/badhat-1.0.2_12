...
class ProductDetailDataCategory with JsonConvert<ProductDetailDataCategory> {
  int id;
  String name;
  @JSONField(name: "updated_at")
  String updatedAt;
...
class ProductDetailDataSubcategory
    with JsonConvert<ProductDetailDataSubcategory> {
  int id;
  String name;
  @JSONField(name: "category_id")
  int categoryId;
